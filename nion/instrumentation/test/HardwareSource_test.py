...
class TestHardwareSourceClass(unittest.TestCase):
    ...
    def test_calibration_provider_basics(self) -> None:
        with self.__simple_test_context() as simple_test_context:
            ...
            self.assertEqual("rad", display_item.display_info.display_calibration_info.displayed_dimensional_calibrations[0].units)
            self.assertEqual("counts", display_item.display_info.display_calibration_info.displayed_intensity_calibration.units)
            display_item.calibration_style_id = "spatial"
            display_item.intensity_calibration_style_id = "intensity-e"
            self.assertEqual("nm", display_item.display_info.display_calibration_info.displayed_dimensional_calibrations[0].units)
            self.assertEqual("e", display_item.display_info.display_calibration_info.displayed_intensity_calibration.units)
