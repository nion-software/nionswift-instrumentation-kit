...
class DriftLogger:
    ...
    def __init__(self, document_model: DocumentModel.DocumentModel, drift_tracker: DriftTracker, event_loop: asyncio.AbstractEventLoop) -> None:
...
class DriftTracker:
    ...
    def __init__(self) -> None:
        ...
        self.__drift_data_frame: numpy.typing.NDArray[numpy.float64] = numpy.zeros((4, 0), float)
