...
class ScanAcquisitionController:
    ...
    def start(self, processing: ScanAcquisitionProcessing, scan_processing: ScanProcessing, *, section_height_override: typing.Optional[int] = None) -> None:
        ...
        self.__synchronized_scan_data_stream.attach_root_data_handler(framed_data_handler)
...
class PanelDelegate:
    ...
    def connect_camera_hardware_source(self, camera_hardware_source: HardwareSource.HardwareSource) -> None:
        ...
        value_format = "{0:." + str(max(1, -exposure_precision - 3)) + "f}"
        exposure_time_ms_value_binding = Binding.PropertyBinding(self.__exposure_time_ms_value_model, "value", converter=Converter.FloatToStringConverter(value_format))
